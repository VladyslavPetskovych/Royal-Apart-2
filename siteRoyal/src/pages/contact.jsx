...
export default function Contact() {
      ...
      <div className=" bg-brand-beige">
          ...
          <div className="relative mx-auto w-full max-w-[1320px] px-6 py-14 lg:py-20">
            ...
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-[780px] font-finlandica text-[12px] leading-[1.75] text-[#1b1b1b]/60 md:text-[13px]">
                Напишіть нам у месенджер або зателефонуйте — допоможемо з
                бронюванням, заселенням, додатковими сервісами та будь-якими
                питаннями під час перебування.
              </p>
            </div>
            ...
            <div className="mt-10 grid gap-10 lg:mt-14 lg:grid-cols-2 lg:gap-14">
              ...
              >
                ...
                <div className="mt-7 grid gap-6 sm:grid-cols-2">
                  <InfoItem label="Адреса">
                    <p>Львів, Україна</p>
                    <p className="text-[#1b1b1b]/55">вул. Весела, 5</p>
                  </InfoItem>
                  ...
                  <InfoItem label="Email">
                    <a
                      href="mailto:info@royalapart.com"
                      className="hover:text-brand-bordo transition-colors"
                    >
        ...
        "
                ...
                <p className="mt-6 font-finlandica text-[12px] leading-[1.7] text-[#1b1b1b]/55">
                  Також можемо допомогти з: трансфером, сніданками, прибиранням,
                  додатковими послугами під час проживання.
                </p>
              </div>
              ...
              <div className="grid gap-10">
                ...
                >
                  ...
                  <div className="mt-5 h-[320px] w-full bg-black/5 sm:h-[360px]">
                    {/* ✅ replace query with your real address */}
                    <iframe
                      title="map"
                ...
                {/* ✅ RIGHT: QUICK CONTACT (NO FORM / NO BACKEND) */}
                <div
                  className="
    rounded-[6px]
    border border-black/10
  ...
  "
    ...
    "
            ...
            {/* bottom spacing like your pages */}
